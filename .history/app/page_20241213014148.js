...
export default function Game() {
    ...
    return (
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column", minHeight: "100vh", backgroundColor: "#f5f5f5", backgroundImage:  "url('/my.webp')", w-full padding: "20px" }}>
            <h1 style={{  color : "white" ,fontFamily: "Arial, sans-serif",   marginBottom: "20px" }}>Bollywood Dialogue Guessing Game 🎥</h1>
            <div style={{ opacity:"0.4", maxWidth: "400px", background: "#fff", borderRadius: "10px", boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)", padding: "20px", textAlign: "center" }}>

...
export default function Game() {
    ...
    return (
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column", minHeight: "100vh", backgroundColor: "#f5f5f5", backgroundImage:  "url('/my.webp')", w:'' padding: "20px" }}>
